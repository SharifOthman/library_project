   ...
   @section('content')
         ...
         <div class="page-content">
          <h1 class="text-center" style="color:09525D">Add Author</h1>
                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="box">
                        <form action="/store_author" method="POST"  enctype="multipart/form-data">
                            @csrf
                        <div class="form-group">
                        <label for="full_name">Name:</label>
                        <input type="text" class="form-control" placeholder="Enter name" id="name" name="full_name">
                        </div>
                        <br>
                         <div class="form-group">
                        ...
                        <input type="date" class="form-control" placeholder="Enter death_date" id="name" name="death_date">
                        </div>
                        <br>
