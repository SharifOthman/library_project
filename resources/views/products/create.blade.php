   ...
   @section('content')
         ...
         <div class="page-content">
          <h1 class="text-center" style="color:09525D">Add Product</h1>
                    ...
                    <div class="container-fluid">
                        ...
                        <input type="text" class="form-control" placeholder="Enter price" id="name" name="price">
                        </div>
                        <br>
                        ...
                        <input type="text" class="form-control" placeholder="Enter offer_discount" id="name" name="offer_discount">
                        </div>
