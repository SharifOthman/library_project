                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="/create_product" >Add</a></li>
                                <li><a href="/list_products" >All</a></li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="/create_author" >Add</a></li>
                                <li><a href="/list_authors">All</a></li>
...
<!--
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="/create_category">Add</a></li>
...
-->
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="/create_article" >Add</a></li>
                                <li><a href="/list_articles" >All</a></li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="/create_owner" >Add</a></li>
                                <li><a href="/list_owners" >All</a></li>
...
<!--
                        <li>
                            <a href="javascript: void(0);" class="waves-effect">
                                ...
                                <span key="t-dashboards">Footer</span>
                            </a>
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="/create_footer" >Add</a></li>
                                <li><a href="/list_footers" >All</a></li>
...
-->
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="/create_slider" >Add</a></li>
                                <li><a href="/list_sliders" >All</a></li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="/create_aboutus" >Add</a></li>
                                <li><a href="/list_aboutuss" >All</a></li>
