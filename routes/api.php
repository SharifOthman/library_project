...
Route::middleware('auth:sanctum')->get('/user', function (Request $request) {
    return $request->user();
     ...
     Route::group(["middleware"=> ["auth:api"]],function(){
        ...
        Route::post("create_product_rate", [UserRatingController::class, "store"]);
        Route::delete("delete_product_rate/{id}", [UserRatingController::class, "destroy"]);

    });
        Route::get("list_product_rates", [UserRatingController::class, "index"]);
